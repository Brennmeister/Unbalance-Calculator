classdef Part < handle
	...
	methods
		...
		function setPrimitive(obj, primitiveType, varargin)
			...
			inpPa = inputParser;
			inpPa.addRequired('primitiveType',			 @(x) any(validatestring(x,{'pointmass', 'cuboid', 'cylinder'})));
			inpPa.addParameter('diameter',			0,	 @isnumeric);		% valide for cylinder
			...
			%% Calculate the inertial tensor for the rotated part
			% This is the inertia in global coordinates.
			% The formula was found with maple
			% Maple > convert(J[PK], 'string')
			
			if false
				%% Map Variables
				% This code block is for the renaming of the maple variable
				% names to the ones in matlab
				jpk='Matrix(3, 3, [[(cos(alpha[x])^2*sin(alpha[y])^2*J[Pz]+(-2*sin(alpha[x])*sin(alpha[y])^2*J[Pyz]-2*cos(alpha[y])*sin(alpha[y])*J[Pxz])*cos(alpha[x])+sin(alpha[x])^2*sin(alpha[y])^2*J[Py]-2*sin(alpha[y])*cos(alpha[y])*sin(alpha[x])*J[Pxy]+J[Px]*cos(alpha[y])^2)*cos(alpha[z])^2+2*(cos(alpha[x])^2*sin(alpha[y])*J[Pyz]+(-sin(alpha[y])*(J[Py]-J[Pz])*sin(alpha[x])+cos(alpha[y])*J[Pxy])*cos(alpha[x])-sin(alpha[x])^2*sin(alpha[y])*J[Pyz]-cos(alpha[y])*J[Pxz]*sin(alpha[x]))*cos(alpha[z])*sin(alpha[z])+sin(alpha[z])^2*(cos(alpha[x])^2*J[Py]+2*sin(alpha[x])*J[Pyz]*cos(alpha[x])+sin(alpha[x])^2*J[Pz])+m*S[yK]^2+m*S[zK]^2,(-cos(alpha[x])^2*sin(alpha[y])*J[Pyz]+(sin(alpha[y])*(J[Py]-J[Pz])*sin(alpha[x])-cos(alpha[y])*J[Pxy])*cos(alpha[x])+sin(alpha[x])*(sin(alpha[x])*sin(alpha[y])*J[Pyz]+cos(alpha[y])*J[Pxz]))*cos(alpha[z])^2+sin(alpha[z])*((sin(alpha[y])^2*J[Pz]-J[Py])*cos(alpha[x])^2+((-2*sin(alpha[y])^2*J[Pyz]-2*J[Pyz])*sin(alpha[x])-2*cos(alpha[y])*sin(alpha[y])*J[Pxz])*cos(alpha[x])+(sin(alpha[y])^2*J[Py]-J[Pz])*sin(alpha[x])^2-2*sin(alpha[y])*cos(alpha[y])*sin(alpha[x])*J[Pxy]+J[Px]*cos(alpha[y])^2)*cos(alpha[z])+(cos(alpha[x])^2*sin(alpha[y])*J[Pyz]+(-sin(alpha[y])*(J[Py]-J[Pz])*sin(alpha[x])+cos(alpha[y])*J[Pxy])*cos(alpha[x])-sin(alpha[x])^2*sin(alpha[y])*J[Pyz]-cos(alpha[y])*J[Pxz]*sin(alpha[x]))*sin(alpha[z])^2-m*S[yK]*S[xK],cos(alpha[z])*cos(alpha[y])*(-J[Px]*sin(alpha[y])-J[Pxy]*cos(alpha[y])*sin(alpha[x])-J[Pxz]*cos(alpha[y])*cos(alpha[x]))-((J[Py]*sin(alpha[x])-J[Pyz]*cos(alpha[x]))*cos(alpha[y])+J[Pxy]*sin(alpha[y]))*(-cos(alpha[z])*sin(alpha[y])*sin(alpha[x])+sin(alpha[z])*cos(alpha[x]))+((J[Pz]*cos(alpha[x])-J[Pyz]*sin(alpha[x]))*cos(alpha[y])+J[Pxz]*sin(alpha[y]))*(cos(alpha[z])*sin(alpha[y])*cos(alpha[x])+sin(alpha[z])*sin(alpha[x]))-m*S[zK]*S[xK]],[(-cos(alpha[x])^2*sin(alpha[y])*J[Pyz]+(sin(alpha[y])*(J[Py]-J[Pz])*sin(alpha[x])-cos(alpha[y])*J[Pxy])*cos(alpha[x])+sin(alpha[x])*(sin(alpha[x])*sin(alpha[y])*J[Pyz]+cos(alpha[y])*J[Pxz]))*cos(alpha[z])^2+sin(alpha[z])*((sin(alpha[y])^2*J[Pz]-J[Py])*cos(alpha[x])^2+((-2*sin(alpha[y])^2*J[Pyz]-2*J[Pyz])*sin(alpha[x])-2*cos(alpha[y])*sin(alpha[y])*J[Pxz])*cos(alpha[x])+(sin(alpha[y])^2*J[Py]-J[Pz])*sin(alpha[x])^2-2*sin(alpha[y])*cos(alpha[y])*sin(alpha[x])*J[Pxy]+J[Px]*cos(alpha[y])^2)*cos(alpha[z])+(cos(alpha[x])^2*sin(alpha[y])*J[Pyz]+(-sin(alpha[y])*(J[Py]-J[Pz])*sin(alpha[x])+cos(alpha[y])*J[Pxy])*cos(alpha[x])-sin(alpha[x])^2*sin(alpha[y])*J[Pyz]-cos(alpha[y])*J[Pxz]*sin(alpha[x]))*sin(alpha[z])^2-m*S[yK]*S[xK],(cos(alpha[x])^2*sin(alpha[y])^2*J[Pz]+(-2*sin(alpha[x])*sin(alpha[y])^2*J[Pyz]-2*cos(alpha[y])*sin(alpha[y])*J[Pxz])*cos(alpha[x])+sin(alpha[x])^2*sin(alpha[y])^2*J[Py]-2*sin(alpha[y])*cos(alpha[y])*sin(alpha[x])*J[Pxy]+J[Px]*cos(alpha[y])^2)*sin(alpha[z])^2-2*(cos(alpha[x])^2*sin(alpha[y])*J[Pyz]+(-sin(alpha[y])*(J[Py]-J[Pz])*sin(alpha[x])+cos(alpha[y])*J[Pxy])*cos(alpha[x])-sin(alpha[x])^2*sin(alpha[y])*J[Pyz]-cos(alpha[y])*J[Pxz]*sin(alpha[x]))*cos(alpha[z])*sin(alpha[z])+cos(alpha[z])^2*(cos(alpha[x])^2*J[Py]+2*sin(alpha[x])*J[Pyz]*cos(alpha[x])+sin(alpha[x])^2*J[Pz])+m*S[xK]^2+m*S[zK]^2,sin(alpha[z])*cos(alpha[y])*(-J[Px]*sin(alpha[y])-J[Pxy]*cos(alpha[y])*sin(alpha[x])-J[Pxz]*cos(alpha[y])*cos(alpha[x]))+(sin(alpha[z])*sin(alpha[y])*sin(alpha[x])+cos(alpha[z])*cos(alpha[x]))*((J[Py]*sin(alpha[x])-J[Pyz]*cos(alpha[x]))*cos(alpha[y])+J[Pxy]*sin(alpha[y]))+((J[Pz]*cos(alpha[x])-J[Pyz]*sin(alpha[x]))*cos(alpha[y])+J[Pxz]*sin(alpha[y]))*(sin(alpha[z])*sin(alpha[y])*cos(alpha[x])-cos(alpha[z])*sin(alpha[x]))-m*S[zK]*S[yK]],[-cos(alpha[z])*(sin(alpha[x])*J[Pxy]+J[Pxz]*cos(alpha[x]))*cos(alpha[y])^2+((cos(alpha[z])*sin(alpha[y])*J[Pz]+sin(alpha[z])*J[Pyz])*cos(alpha[x])^2-2*(cos(alpha[z])*sin(alpha[y])*J[Pyz]+1/2*sin(alpha[z])*(J[Py]-J[Pz]))*sin(alpha[x])*cos(alpha[x])-sin(alpha[y])*(-sin(alpha[x])^2*J[Py]+J[Px])*cos(alpha[z])-sin(alpha[x])^2*sin(alpha[z])*J[Pyz])*cos(alpha[y])+((cos(alpha[z])*sin(alpha[y])*J[Pxz]-sin(alpha[z])*J[Pxy])*cos(alpha[x])+sin(alpha[x])*(cos(alpha[z])*sin(alpha[y])*J[Pxy]+sin(alpha[z])*J[Pxz]))*sin(alpha[y])-m*S[zK]*S[xK],-sin(alpha[z])*(sin(alpha[x])*J[Pxy]+J[Pxz]*cos(alpha[x]))*cos(alpha[y])^2+((sin(alpha[y])*sin(alpha[z])*J[Pz]-cos(alpha[z])*J[Pyz])*cos(alpha[x])^2+sin(alpha[x])*(-2*sin(alpha[y])*sin(alpha[z])*J[Pyz]+cos(alpha[z])*(J[Py]-J[Pz]))*cos(alpha[x])+(sin(alpha[y])*sin(alpha[z])*J[Py]+cos(alpha[z])*J[Pyz])*sin(alpha[x])^2-J[Px]*sin(alpha[y])*sin(alpha[z]))*cos(alpha[y])+((sin(alpha[y])*sin(alpha[z])*J[Pxz]+cos(alpha[z])*J[Pxy])*cos(alpha[x])-sin(alpha[x])*(-sin(alpha[y])*sin(alpha[z])*J[Pxy]+cos(alpha[z])*J[Pxz]))*sin(alpha[y])-m*S[zK]*S[yK],(sin(alpha[x])^2*J[Py]-2*sin(alpha[x])*J[Pyz]*cos(alpha[x])+J[Pz]*cos(alpha[x])^2)*cos(alpha[y])^2+2*sin(alpha[y])*(sin(alpha[x])*J[Pxy]+J[Pxz]*cos(alpha[x]))*cos(alpha[y])+sin(alpha[y])^2*J[Px]+m*S[xK]^2+m*S[yK]^2]])';
				...
				s=regexprep(s,	'Matrix\(3, 3, \[\['    , '['  );
				s=regexprep(s,  '\],\['					, ';           '); % Zeilen im Vektor herstellen
				s=regexprep(s,  ',([a-Z \(])'            , ' , $1'       ); % Spaltentrennung kenntlich machen
				s=regexprep(s,  '\]\]\)$'               , '];'          );
				...
				if false
					...
					% Calculate the values of the needed variables
					eul = obj.getGlobalEulerAngles;
					alpha_z = eul(1);
					alpha_y = eul(2);
					alpha_x = eul(3);
					...
					mass = obj.mass;
					sp = obj.getGlobalPosition;
					% Calculate the global inertia
					obj.j = [(cos(alpha_x)^2*sin(alpha_y)^2*j(3,3)+(-2*sin(alpha_x)*sin(alpha_y)^2*j(2,3)-2*cos(alpha_y)*sin(alpha_y)*j(1,3))*cos(alpha_x)+sin(alpha_x)^2*sin(alpha_y)^2*j(2,2)-2*sin(alpha_y)*cos(alpha_y)*sin(alpha_x)*j(1,2)+j(1,1)*cos(alpha_y)^2)*cos(alpha_z)^2+2*(cos(alpha_x)^2*sin(alpha_y)*j(2,3)+(-sin(alpha_y)*(j(2,2)-j(3,3))*sin(alpha_x)+cos(alpha_y)*j(1,2))*cos(alpha_x)-sin(alpha_x)^2*sin(alpha_y)*j(2,3)-cos(alpha_y)*j(1,3)*sin(alpha_x))*cos(alpha_z)*sin(alpha_z)+sin(alpha_z)^2*(cos(alpha_x)^2*j(2,2)+2*sin(alpha_x)*j(2,3)*cos(alpha_x)+sin(alpha_x)^2*j(3,3))+mass*sp(2)^2+mass*sp(3)^2 , (-cos(alpha_x)^2*sin(alpha_y)*j(2,3)+(sin(alpha_y)*(j(2,2)-j(3,3))*sin(alpha_x)-cos(alpha_y)*j(1,2))*cos(alpha_x)+sin(alpha_x)*(sin(alpha_x)*sin(alpha_y)*j(2,3)+cos(alpha_y)*j(1,3)))*cos(alpha_z)^2+sin(alpha_z)*((sin(alpha_y)^2*j(3,3)-j(2,2))*cos(alpha_x)^2+((-2*sin(alpha_y)^2*j(2,3)-2*j(2,3))*sin(alpha_x)-2*cos(alpha_y)*sin(alpha_y)*j(1,3))*cos(alpha_x)+(sin(alpha_y)^2*j(2,2)-j(3,3))*sin(alpha_x)^2-2*sin(alpha_y)*cos(alpha_y)*sin(alpha_x)*j(1,2)+j(1,1)*cos(alpha_y)^2)*cos(alpha_z)+(cos(alpha_x)^2*sin(alpha_y)*j(2,3)+(-sin(alpha_y)*(j(2,2)-j(3,3))*sin(alpha_x)+cos(alpha_y)*j(1,2))*cos(alpha_x)-sin(alpha_x)^2*sin(alpha_y)*j(2,3)-cos(alpha_y)*j(1,3)*sin(alpha_x))*sin(alpha_z)^2-mass*sp(2)*sp(1),cos(alpha_z)*cos(alpha_y)*(-j(1,1)*sin(alpha_y)-j(1,2)*cos(alpha_y)*sin(alpha_x)-j(1,3)*cos(alpha_y)*cos(alpha_x))-((j(2,2)*sin(alpha_x)-j(2,3)*cos(alpha_x))*cos(alpha_y)+j(1,2)*sin(alpha_y))*(-cos(alpha_z)*sin(alpha_y)*sin(alpha_x)+sin(alpha_z)*cos(alpha_x))+((j(3,3)*cos(alpha_x)-j(2,3)*sin(alpha_x))*cos(alpha_y)+j(1,3)*sin(alpha_y))*(cos(alpha_z)*sin(alpha_y)*cos(alpha_x)+sin(alpha_z)*sin(alpha_x))-mass*sp(3)*sp(1);           (-cos(alpha_x)^2*sin(alpha_y)*j(2,3)+(sin(alpha_y)*(j(2,2)-j(3,3))*sin(alpha_x)-cos(alpha_y)*j(1,2))*cos(alpha_x)+sin(alpha_x)*(sin(alpha_x)*sin(alpha_y)*j(2,3)+cos(alpha_y)*j(1,3)))*cos(alpha_z)^2+sin(alpha_z)*((sin(alpha_y)^2*j(3,3)-j(2,2))*cos(alpha_x)^2+((-2*sin(alpha_y)^2*j(2,3)-2*j(2,3))*sin(alpha_x)-2*cos(alpha_y)*sin(alpha_y)*j(1,3))*cos(alpha_x)+(sin(alpha_y)^2*j(2,2)-j(3,3))*sin(alpha_x)^2-2*sin(alpha_y)*cos(alpha_y)*sin(alpha_x)*j(1,2)+j(1,1)*cos(alpha_y)^2)*cos(alpha_z)+(cos(alpha_x)^2*sin(alpha_y)*j(2,3)+(-sin(alpha_y)*(j(2,2)-j(3,3))*sin(alpha_x)+cos(alpha_y)*j(1,2))*cos(alpha_x)-sin(alpha_x)^2*sin(alpha_y)*j(2,3)-cos(alpha_y)*j(1,3)*sin(alpha_x))*sin(alpha_z)^2-mass*sp(2)*sp(1) , (cos(alpha_x)^2*sin(alpha_y)^2*j(3,3)+(-2*sin(alpha_x)*sin(alpha_y)^2*j(2,3)-2*cos(alpha_y)*sin(alpha_y)*j(1,3))*cos(alpha_x)+sin(alpha_x)^2*sin(alpha_y)^2*j(2,2)-2*sin(alpha_y)*cos(alpha_y)*sin(alpha_x)*j(1,2)+j(1,1)*cos(alpha_y)^2)*sin(alpha_z)^2-2*(cos(alpha_x)^2*sin(alpha_y)*j(2,3)+(-sin(alpha_y)*(j(2,2)-j(3,3))*sin(alpha_x)+cos(alpha_y)*j(1,2))*cos(alpha_x)-sin(alpha_x)^2*sin(alpha_y)*j(2,3)-cos(alpha_y)*j(1,3)*sin(alpha_x))*cos(alpha_z)*sin(alpha_z)+cos(alpha_z)^2*(cos(alpha_x)^2*j(2,2)+2*sin(alpha_x)*j(2,3)*cos(alpha_x)+sin(alpha_x)^2*j(3,3))+mass*sp(1)^2+mass*sp(3)^2,sin(alpha_z)*cos(alpha_y)*(-j(1,1)*sin(alpha_y)-j(1,2)*cos(alpha_y)*sin(alpha_x)-j(1,3)*cos(alpha_y)*cos(alpha_x))+(sin(alpha_z)*sin(alpha_y)*sin(alpha_x)+cos(alpha_z)*cos(alpha_x))*((j(2,2)*sin(alpha_x)-j(2,3)*cos(alpha_x))*cos(alpha_y)+j(1,2)*sin(alpha_y))+((j(3,3)*cos(alpha_x)-j(2,3)*sin(alpha_x))*cos(alpha_y)+j(1,3)*sin(alpha_y))*(sin(alpha_z)*sin(alpha_y)*cos(alpha_x)-cos(alpha_z)*sin(alpha_x))-mass*sp(3)*sp(2);           -cos(alpha_z)*(sin(alpha_x)*j(1,2)+j(1,3)*cos(alpha_x))*cos(alpha_y)^2+((cos(alpha_z)*sin(alpha_y)*j(3,3)+sin(alpha_z)*j(2,3))*cos(alpha_x)^2-2*(cos(alpha_z)*sin(alpha_y)*j(2,3)+1/2*sin(alpha_z)*(j(2,2)-j(3,3)))*sin(alpha_x)*cos(alpha_x)-sin(alpha_y)*(-sin(alpha_x)^2*j(2,2)+j(1,1))*cos(alpha_z)-sin(alpha_x)^2*sin(alpha_z)*j(2,3))*cos(alpha_y)+((cos(alpha_z)*sin(alpha_y)*j(1,3)-sin(alpha_z)*j(1,2))*cos(alpha_x)+sin(alpha_x)*(cos(alpha_z)*sin(alpha_y)*j(1,2)+sin(alpha_z)*j(1,3)))*sin(alpha_y)-mass*sp(3)*sp(1),-sin(alpha_z)*(sin(alpha_x)*j(1,2)+j(1,3)*cos(alpha_x))*cos(alpha_y)^2+((sin(alpha_y)*sin(alpha_z)*j(3,3)-cos(alpha_z)*j(2,3))*cos(alpha_x)^2+sin(alpha_x)*(-2*sin(alpha_y)*sin(alpha_z)*j(2,3)+cos(alpha_z)*(j(2,2)-j(3,3)))*cos(alpha_x)+(sin(alpha_y)*sin(alpha_z)*j(2,2)+cos(alpha_z)*j(2,3))*sin(alpha_x)^2-j(1,1)*sin(alpha_y)*sin(alpha_z))*cos(alpha_y)+((sin(alpha_y)*sin(alpha_z)*j(1,3)+cos(alpha_z)*j(1,2))*cos(alpha_x)-sin(alpha_x)*(-sin(alpha_y)*sin(alpha_z)*j(1,2)+cos(alpha_z)*j(1,3)))*sin(alpha_y)-mass*sp(3)*sp(2) , (sin(alpha_x)^2*j(2,2)-2*sin(alpha_x)*j(2,3)*cos(alpha_x)+j(3,3)*cos(alpha_x)^2)*cos(alpha_y)^2+2*sin(alpha_y)*(sin(alpha_x)*j(1,2)+j(1,3)*cos(alpha_x))*cos(alpha_y)+sin(alpha_y)^2*j(1,1)+mass*sp(1)^2+mass*sp(2)^2];
				end
			end
